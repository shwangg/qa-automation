module Sidebar
  ...
  def related_proc_button
    (@deployment == Deployment::PAHMA) ? button_locator('Actions') : button_locator('Procedures')
  end

  def related_proc_expanded_div
    (@deployment == Deployment::PAHMA) ? expanded_div_locator('Actions') : expanded_div_locator('Procedures')
  end

  def related_proc_links
    (@deployment == Deployment::PAHMA) ? links_locator('Actions') : links_locator('Procedures')
  end
  ...
  def related_proc_num_per_page_input
    (@deployment == Deployment::PAHMA) ? num_per_page_input('Actions') : num_per_page_input('Procedures')
  end

  def related_proc_num_per_page_option
    (@deployment == Deployment::PAHMA) ? num_per_page_option('Actions') : num_per_page_option('Procedures')
  end
