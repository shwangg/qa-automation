...
[Deployment::CORE_UCB, Deployment::PAHMA].each do |deploy|
  ...
  describe 'Use of Collection records' do
    ...
    context 'once created and saved' do
      ...
      it("show the right #{(deploy == Deployment::PAHMA) ? 'Types of Use' : 'Methods'}") { @use_of_collections_page.verify_methods @uoc_1 }
      it('show the right Collection Types') { @use_of_collections_page.verify_collection_types @uoc_1 }
      it("show the right #{(deploy == Deployment::PAHMA) ? 'Research Types' : 'Material Types'}") { @use_of_collections_page.verify_material_types @uoc_1 }
    ...
    context 'when edited' do
      ...
      it("show the right #{(deploy == Deployment::PAHMA) ? 'Types of Use' : 'Methods'}") { @use_of_collections_page.verify_methods @uoc_2 }
      it('show the right Collection Types') { @use_of_collections_page.verify_collection_types @uoc_2 }
      it("show the right #{(deploy == Deployment::PAHMA) ? 'Research Types' : 'Material Types'}") { @use_of_collections_page.verify_material_types @uoc_2 }
