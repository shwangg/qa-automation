...
describe "Inventory / movement" do
  ...
  before(:all) do
    ...
    @test_data = @test.inventory_movement_test_data @test.deployment
    ...
    @object_page.enter_pahma_museum_number @object
  ...
  describe 'creation' do
    ...
    it 'can be done via Create New' do
      ...
      @inventory_movement_page.create_unlocked_pahma_movement @move_0
    end

    it 'can be done on an object\'s secondary tab' do
      @object_page.get @object[:url]
      @object_page.click_pahma_movement_secondary_tab
      @object_page.click_create_new_button
      @inventory_movement_page.create_unlocked_pahma_movement @move_1
    end
    ...
    it 'can be done by cloning an existing inventory/movement on an object\'s secondary tab' do
      ...
      @inventory_movement_page.create_unlocked_pahma_movement @move_2
    end

    it 'can be created via another inventory/movement\'s secondary tab' do
      @inventory_movement_page.click_open_link
      @inventory_movement_page.click_pahma_movement_secondary_tab
      @inventory_movement_page.click_create_new_button
      @inventory_movement_page.create_unlocked_pahma_movement @move_3
    end
  end
  ...
  describe 'relating to an object' do
    ...
    context 'when done via the object secondary tab search' do
      ...
      before(:all) do
        ...
        @create_new_page.click_create_new_movement
        @inventory_movement_page.create_unlocked_pahma_movement @move_4
    ...
    context 'when done via the object sidebar Related Actions' do
      ...
      before(:all) do
        ...
        @inventory_movement_page.click_create_new_link
        @create_new_page.click_create_new_movement
        @inventory_movement_page.create_unlocked_pahma_movement @move_5
    ...
    context 'when done via the inventory/movement sidebar related objects' do
      ...
      before(:all) do
        ...
        @inventory_movement_page.click_create_new_link
        @create_new_page.click_create_new_movement
        @inventory_movement_page.create_unlocked_pahma_movement @move_6
    ...
    context 'when no later inventory/movement is related to the object' do
      ...
      before do
        ...
        @inventory_movement_page.create_unlocked_pahma_movement @move_7
