...
Scenario: Test Internal Search Portal
    ...
    Then I verify the search fields "Accession Number, Scientific Name, Family, Collector Number, Collection Date, Field Collection Place, County, State, Country, Flower Color, Flowering (months), Fruiting (months), Infraspecific Epithet, Access Restrictions, Specific Epithet, Rank Marker"
...
#    Then I find the content "Dry arid succulent bush" in "input#habitat"
    ...
    Then I will click "Reset" and the "family" select should have visible option "Please select"
